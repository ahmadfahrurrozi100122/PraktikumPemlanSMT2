...
public class transaksiSwalayan {
   ...
   private void jenisKartu(String nomor) {
      if (getJenis().equals("38")) {
         ...
         System.out.println(
               "Anda akan mendapatkan cashback sebesar 7% untuk setiap pembelian diatas 1 jt. Selain itu cashback 2%.");
      } else if (getJenis().equals("74")) {
         System.out.println("Anda merupakan pelanggan jenis platinum");
         System.out.println(
               "Anda akan mendapatkan cashback sebesar 10% untuk setiap pembelian diatas 1 jt. Selain itu cashback 5%.");
      } else {
